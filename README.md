...
* Библиотека ПК. Выпуск 1. ВЕКТОР-06Ц ИЗНУТРИ. Руководство для начинающих специалистов.
* Библиотека ПК. Выпуск 2. Системные программы МикроДОС ПК Вектор-06Ц.
* Библиотека ПК. Выпуск 3. Язык программирования ЛС-ПАСКАЛЬ.
```
