    ...
    -------|---
           ...
           | Данная GIF-анимация была сделана из SPR-файлов взятых с Вектор'а-06Ц.
           |---
    ...
    внутри есть описание.
       ...
       Примечание.
       Внутри SPR-архивов также есть программы для просмотра SPR-файлов
    ...
    "spr2bmp.pl"  - Скрипт на Perl (SPR-файл в BMP-файл). Этот скрипт ещё умеет
